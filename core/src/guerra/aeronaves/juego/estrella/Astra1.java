package guerra.aeronaves.juego.estrella;
...
public class Astra1
{
         ...
         */
        public Astra1 (NodoAstar[][] matriz, NodoAstar nodoInicial, NodoAstar nodoFinal, boolean forzar8conectado)
        {
                this.matriz = matriz;
        ...
        public ArrayList calcularCamino()
        {
                ...
                listaAbierta.push((Comparable) nodoInicial);
